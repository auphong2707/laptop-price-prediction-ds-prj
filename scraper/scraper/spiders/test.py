...
class Test(scrapy.Spider):
    ...
    start_urls = [
        "https://gearvn.com/products/laptop-gaming-gigabyte-a5-k1-avn1030sb",
        "https://gearvn.com/products/laptop-acer-aspire-5-a515-58p-71ej",
        "https://gearvn.com/products/laptop-gaming-msi-thin-a15-b7ucx-020vn",
    ]
    ...
    def parse_battery_capacity(self, response: Response): 
        ...
        try:
            ...
            search_value = re.search(r'(\d+(?:\.\d+)?)\s*wh', res)
            if search_value:
    ...
    def parse_weight(self, response: Response): 
        ...
        """
        try:
            res = self.get_scoped_value(response, ['Trọng lượng', 'Trọng lượng']).lower()
    ...
    def parse_default_os(self, response: Response): 
        ...
        try:
            ...
            res = re.sub(r'[^\x20-\x7E]|Single Language|SL', ' ', res, flags=re.IGNORECASE)
            res = ' '.join(res.split())
